...
#
# Many controls here loop over a collection and describe each member. A service
# can be in scope while the account holds none of that resource — no Redshift
# clusters, no DocumentDB, no Neptune — and the loop then never executes. Without
